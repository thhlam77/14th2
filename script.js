const CONFIG = {
    ...
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Không được đâu😝", "Hehe, hỏng đc mò 😜", "Thôi đằng nào cũng là của anh 💕"],
    confirmTitle: "YAAAY! Ỏo 💗",
    confirmText: "Vợ đồng ý sao…",
    badgeText: "Yêu vợ thíaaa 💗",
    nextButton: "Tiếp tục ",
    repeatButton: "Lặp lại câu hỏi",
    flowerTitle: "Đây là món quà tặng cho vợ nè  ",
    takeBouquetButton: "Nhận quàaa ",
    bouquetMessage: "Tuyệt! Giờ nó là của vợ gòii 💕",
    nextFlowerButton: "Tiếp tục ",
    collageTitle: "Bé iu của anh",
    collageSubtitle: "Từ khi em đến, ngay cả những điều đơn giản nhất cũng trở nên đặc biệt. Chúc mừng ngày Valentine, người anh yêu quý nhất. 💕",
    nextCollageButton: "Tiếp tục đến trang cuối…",
    finalTitle: "Happy Valentine, vợ iu 💞",
    finalMessage: `Cảm ơn vợ vì đã luôn ở bên cạnh và làm cho những ngày của anh luôn trọn vẹn.Vợ là lý do khiến anh dễ dàng nở nụ cười. Chúc những ngày của vợ luôn tràn ngập ấm áp và hạnh phúc. Anh luôn ở đây vì vợ. Chúc mừng ngày Valentine 💕`,
